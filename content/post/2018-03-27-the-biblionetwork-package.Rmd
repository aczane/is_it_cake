...
```
Now! We're going to make a final column that contains all descriptors of each candy, using `dplyr::unite`.[^2]
...
# and deal with the extra white spaces
...
[^2]: To my knowledge, there isn't a clean way of dealing with NA in `unite` yet, so this is a bit of a messy workaround.
