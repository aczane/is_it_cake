...
The documentation is all there, and theoretically you should read it all, but I tend to learn best by doing; I'll run through the basics so that I understand where to start, but I find it the most helpful to see the .Rmd and the final output, and learn that way. Then it's handy to have the resources afterward so that I can troubleshoot.
