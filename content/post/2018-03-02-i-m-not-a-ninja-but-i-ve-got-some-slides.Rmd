...
[^3]: If you want it to work in Safari, you do need to add the #1 to the url of your slides, or else it will not work. E.g.,
knitr::include_url('http://aczane.netlify.com/slides/xaringan_example_acz.html#1').I followed [directions for embedding slide decks into blogdown posts from Tim Mastny here](https://timmastny.rbind.io/blog/embed-slides-knitr-blogdown/). 